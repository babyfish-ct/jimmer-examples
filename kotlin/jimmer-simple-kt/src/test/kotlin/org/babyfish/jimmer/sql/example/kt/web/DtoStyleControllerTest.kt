...
class DtoStyleControllerTest(
    ...
    fun testFindSimpleRootTreeNodes() {
        mockMvc.get("/dto/rootTreeNodes/simple").andExpect {
            status { isOk() }
            content {
                json(
    ...
    fun testFindRecursiveRootTreeNodes() {
        mockMvc.get("/dto/rootTreeNodes/recursive").andExpect {
            status { isOk() }
            content {
                json(
