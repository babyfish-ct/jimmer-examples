...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="./jimmer-sql-graphql">java/jimmer-sql-graphql</a></td>
            <td>Quickly build GraphQL services using Jimmer</td>
            <td>★★</td>
        </tr>
        <tr>
            <td><a href="./jimmer-cloud">java/jimmer-cloud</a></td>
            <td>A microservices project based on Spring Cloud, showcasing Jimmer's remote association</td>
            <td>★</td>
        </tr>
        <tr>
            <td><a href="./save-command">java/save-command</a></td>
